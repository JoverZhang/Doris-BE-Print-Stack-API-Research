...
echo "just ck-system-stack-trace-fp-build"
echo
...
echo "- If <scheme>/build/fp/programs/clickhouse already exists, the scheme reuses it; otherwise it builds from <repo>/repos/source/ClickHouse-v26.3.10.62-lts."
echo
